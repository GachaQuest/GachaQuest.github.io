System.register(['@urql/core', 'jotai', 'wonka'], (function (exports) {
  'use strict';
  var createClient, atom, pipe, subscribe;
  return {
    ...
    execute: (function () {
        ...
        const queryAtom = atom((get) => {
          ...
          switch (action.type) {
            case "reexecute": {
              ...
              const newSubscription = pipe(client.query(args.query, args.variables, {
                ...args.requestPolicy && { requestPolicy: args.requestPolicy },
                ...args.context,
                ...action.opts
              }), subscribe(listener));
      ...
      function atomWithSubscription(createSubscriptionArgs, getClient = (get) => get(clientAtom)) {
        const queryResultAtom = atom((get) => {
          ...
          let subscription = pipe(client.subscription(args.query, args.variables, args.context), subscribe(listener));
