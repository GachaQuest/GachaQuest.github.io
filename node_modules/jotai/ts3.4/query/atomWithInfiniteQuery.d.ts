...
declare type AtomWithInfiniteQueryAction<TQueryFnData> = ({
    type: 'refetch';
...
export interface AtomWithInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryData> extends InfiniteQueryObserverOptions<TQueryFnData, TError, TData, TQueryData> {
    queryKey: QueryKey;
}
export interface AtomWithInfiniteQueryOptionsWithEnabled<TQueryFnData, TError, TData, TQueryData> extends Pick<AtomWithInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryData>, Exclude<keyof AtomWithInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryData>, 'enabled'>> {
    enabled: boolean;
}
